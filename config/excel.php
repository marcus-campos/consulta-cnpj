...
return array(
    ...
    'properties' => [
        'creator'        => 'Consulta CNPJ',
        'lastModifiedBy' => 'Consulta CNPJ',
        'title'          => 'CNPJsExportados',
        'description'    => 'CNPJs expostados do software Consulta CNPJ',
        'subject'        => 'Consulta CNPJ export',
        'keywords'       => 'consulta, cpnj, excel, export',
        'category'       => 'Excel',
        'manager'        => 'Consulta CNPJ',
        'company'        => 'Devyzi',
    ],
